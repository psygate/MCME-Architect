...
public class ItemBlockCommand extends AbstractArchitectCommand {
    ...
    public boolean onCommand(CommandSender cs, Command command, String label, String[] args) {
        ...
        Player p = (Player) cs;
        if(!PluginData.hasPermission(p,Permission.ITEM_BLOCK_REMOVE_COMMAND)) {
    ...
    public String getHelpPermission() {
        return Permission.ITEM_BLOCK_REMOVE_COMMAND.getPermissionNode();
    }

    @Override
    public String getShortDescription() {
        return ": Removes item block armor stands.";
    }
    @Override
    public String getUsageDescription() {
        return " remove <radius> [yRadius]: Removes all item block armor stands within <radius> blocks around you. Additional argument [yRadius] can be used to specify a differing radius along y-axis.";
    }
